...
<main>
    <section class="relative">
        <div class="container px-4 mx-auto mt-8">
            <?= getAllFlashes() ?>
            <form class="bg-white rounded-xl shadow px-4 py-6" action="<?= route_url('users.create') ?>"
                  method="post">
                <?= csrf_input() ?>
                <div class="p-4">
                        ...
                        <div class="w-full px-4 mb-4">
                            ...
                            <div class="flex gap-x-3">
                                <label class="inline-flex items-center">
                                    <input id="permissions" type="radio" value="admin" name="permissions[]">
                                    <span class="ml-2">Administrador</span>
                                </label>
                                <label class="inline-flex items-center">
                                    <input id="permissions" type="radio" value="editor" name="permissions[]">
                                    <span class="ml-2">Editor</span>
                                </label>
                                <label class="inline-flex items-center">
                                    <input id="permissions" type="radio" value="default" name="permissions[]">
